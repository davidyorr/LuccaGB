...
func TestBoop__solid_color_0_window(t *testing.T) {
	...
	runPpuTest(t, "boop/solid-color-0-window", 1000, "beaca6d8b5aec6a02fe4db04662136db628ec2543d396d03601853067dd47eac")
}
...
func TestBoop__sprite_8x8(t *testing.T) {
	// adjust the frameToRun after this tests passes
	runPpuTest(t, "boop/sprite-8x8", 1000, "c6f656c7c2a60a2359837ba585ebf16e72aade3fd471dce94b15b1922e5572bc")
}

func TestBoop__sprite_8x16(t *testing.T) {
	// adjust the frameToRun after this tests passes
	runPpuTest(t, "boop/sprite-8x16", 1000, "8b47c129eea87cde106a185aaabd88dd606f26522f3ed1b4b5eece88eee82d0d")
}
